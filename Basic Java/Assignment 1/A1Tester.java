...
public class A1Tester {
	...
	public static void testGreatestCommonDenominator() {
		...
		expected = 1;
		System.out.println("Testing greatestCommonDenominator(1, 2)");
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		...
		result = A1Exercises.greatestCommonDenominator(24, 6);
		expected = 6;
		System.out.println("Testing greatestCommonDenominator(24, 6)");
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		
		result = A1Exercises.greatestCommonDenominator(10, 10);
		expected = 10;
		System.out.println("Testing greatestCommonDenominator(10, 10)");
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		
		result = A1Exercises.greatestCommonDenominator(100, 35);
		expected = 5;
		System.out.println("Testing greatestCommonDenominator(100, 35)");
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
	}
	...
	public static void testCountMatches() {
		...
		result = A1Exercises.countMatches(arr3, 6);
		expected = 0;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
	}  
